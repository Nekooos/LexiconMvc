    ...
    public partial class identity1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6, 11, "StockHolm" });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "CityId", "CountryId", "Name" },
                values: new object[] { 7, 11, "Göteborg" });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "CityId", "CountryId", "Name" },
                values: new object[] { 8, 12, "Oslo" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 6, "Kristoffer", "0731112233" },
                    { 4, 6, "Marcus", "0731112233" },
                    { 2, 7, "Sara", "0731112233" },
                    { 3, 8, "Björgen", "0731112233" }
                });
